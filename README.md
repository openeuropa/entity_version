...
Entity version allows to attach version number to content revisions that help content editors to understand and version the evolution of the content item. 
